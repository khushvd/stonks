...
export function buildSynthesisPrompt(company: string, ask: string | null, industry: string | null): string {
  ...
  return [
    ...
    `with annual reports / presentations:`,
    `  - answer:       a direct, evidence-backed answer to the ASK`,
    `  - guidance:     management's explicit guidance — what volumes/margins/capex they guided for,`,
    `                  what language they used (confident vs hedged), what they committed to and`,
    `                  what they conspicuously avoided. Quote management where possible.`,
    `  - drivers:      what moved revenue and margins this period and why — price vs volume split,`,
    `                  input cost trends, operating leverage, product mix, channel dynamics.`,
    `  - risks:        key risks, red flags, or concerns — including what analysts pushed back on`,
    `                  in the concall Q&A and how management responded (or deflected).`,
